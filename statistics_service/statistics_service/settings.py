...
SECRET_KEY = env('SECRET_KEY', default='django-insecure-!yecicjdim&(@^-&yk!g&eu3h+0c)-o9c4%%d7ar!xrcx6f625')
...
ASGI_APPLICATION = 'traffic_service.routing.application'
CHANNEL_LAYERS = {
    'default': {
...
# File paths
SHARED_STORAGE_PATH = env('SHARED_STORAGE_PATH', default='/shared')
