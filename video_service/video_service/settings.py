...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-9f)m$beu2(_q8+n3zsl4o0tsgmxeqauocj$_l35bimn4ebp@cc')
...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:5173",
    "http://172.20.147.45:5173",  # WSL network IP
    "http://127.0.0.1:5173",
]
...
DATABASES = {
    'default': {
        ...
        'NAME': config('DB_NAME', default='video_db'),
...
SHARED_STORAGE_PATH = config('SHARED_STORAGE_PATH', default='/shared')
